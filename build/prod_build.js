...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(2),
	    PureRenderMixin = __webpack_require__(2).addons.PureRenderMixin,
	    d3 = __webpack_require__(4);

	var BubbleChart = __webpack_require__(5),
	    Filters = __webpack_require__(15);

	var ApplicantsChart = React.createClass({
	    displayName: 'ApplicantsChart',
	    ...
	    updateData: function updateData(data, N_all, caption) {
	        this.setState({ data: data,
	            N_all: N_all,
	            caption: caption });
	    },

	    updatePassValue: function updatePassValue(value, N_above, N_below) {
	    ...
	    render: function render() {
	        ...
	        if (data) {
	            var flatData = data.reduce(function (mem, d) {
	            ...
	            chart = React.createElement(
	                ...
	                React.createElement(BubbleChart, _extends({ data: flatData,
	        ...
	        return React.createElement(
	            'div',
	            { className: 'applicants-chart' },
	            chart,
	            React.createElement(Filters, { urlRoot: this.props.urlRoot,
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Candidate = __webpack_require__(10),
	    CandidateTooltip = __webpack_require__(6),
	    PassLine = __webpack_require__(12),
	    BucketCounts = __webpack_require__(13),
	    Axis = __webpack_require__(14);
	...
	var BubbleChart = React.createClass({
	    ...
	    getDefaultProps: function getDefaultProps() {
	        ...
	        return {
	            y_value: function y_value(d) {
	                return d.OverallScore;
	            },
	            x_value: function x_value(d) {
	                return d.randomProp;
	            },
	            r_value: function r_value(d) {
	                return d.OverallScore;
	            },
	            margin: {
	                top: 10,
	    ...
	    onZoom: function onZoom() {
	        var multiplier = this.zoomScaleMultiplier(d3.event.scale);

	        this.rScale.range([1, this.props.max_r].map(function (v) {
	            return v * multiplier;
	        }));
	    ...
	    panLimit: function panLimit() {
	        var panExtent = this.panExtent,
	            y = this.yScale,
	            x = this.xScale,
	            zoom = this.zoom,
	        ...
	        var divisor = { h: height / ((y.domain()[1] - y.domain()[0]) * zoom.scale()), w: width / ((x.domain()[1] - x.domain()[0]) * zoom.scale()) },
	            ...
	            tx = x.domain()[0] < panExtent.x[0] ? minX : x.domain()[1] > panExtent.x[1] ? maxX : zoom.translate()[0],
	    ...
	    hide_tooltips: function hide_tooltips(event) {
	        _.keys(this.refs).forEach((function (key) {
	            ...
	            if (!event.dispatchMarker.match(key) && key.match(/^candidate-tooltip/)) {
	                component.hide();
	            }
	        }).bind(this));
	    },

	    toggle_tooltip: function toggle_tooltip(id) {
	        var tooltip = this.refs['candidate-tooltip-' + id];
	    ...
	    __build_tooltips: function __build_tooltips() {
	        return React.createElement(
	            'g',
	            null,
	            this.props.data.map(function (d) {
	                return React.createElement(CandidateTooltip, {
	    ...
	    render: function render() {
	        ...
	        return React.createElement(
	            ...
	            candidates,
	            React.createElement(Axis, _extends({}, this.props, { yScale: this.yScale })),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Stars = __webpack_require__(9);
	...
	var CandidateTooltip = React.createClass({
	    ...
	    calc_offsets: function calc_offsets(props) {
	        var x_offset = 0,
	            y_offset = 0;
	    ...
	    shouldComponentUpdate: function shouldComponentUpdate(nextProps, nextState) {
	        return _.any([nextProps.width !== this.props.width, nextProps.height !== this.props.height, nextState.shown !== this.state.shown, !_.isEqual(nextProps.data, this.props.data)]);
	    },
	        ...
	        return React.createElement(
	            ...
	            React.createElement(
	                ...
	                React.createElement(
	                    'div',
	                    null,
	                    React.createElement('img', { src: candidate.Photo }),
	                    React.createElement(
	                        'div',
	                        { className: 'info' },
	                        React.createElement(
	                    ...
	                    React.createElement(Stars, { score: this.props.data.StarRating }),
	                    React.createElement(
	                        'strong',
	                        { className: 'score' },
	                        this.props.data.OverallScore
	                    )
	                )
	            )
	        );
	    ...
	    render: function render() {
	        return React.createElement(
	            ...
	            _.range(10).map((function (i) {
	                ...
	                return React.createElement('span', { className: 'glyphicon ' + icon,
	                    key: 'star-' + i });
	            }).bind(this))
	        );
	    }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var CandidateTooltip = __webpack_require__(6),
	...
	var Candidate = React.createClass({
	    ...
	    toggle_tooltip: function toggle_tooltip() {
	        this.props.toggle_tooltip(this.props.data.id);
	    },

	    componentDidMount: function componentDidMount() {
	        d3.select(this.getDOMNode()).datum({ id: 'candidate-' + this.props.data.id });
	    },
	    ...
	    render: function render() {
	        ...
	        var className = ['candidate', gender, this.props.passed ? 'passed' : 'no-passed'].join(' ');
	        ...
	        return React.createElement(
	            'g',
	            { transform: 'translate(' + (this.props.x + this.state.x_offset) + ', ' + (this.props.y + this.state.y_offset) + ')',
	    ...
	    render: function render() {
	        ...
	        return React.createElement(
	            ...
	            { onMouseDown: this.startDrag,
	                ...
	                className: 'pass-line' },
	            React.createElement('line', { x1: this.props.margin.left, y1: this.state.y - 1,
	                x2: '100%', y2: this.state.y - 1,
	                style: { stroke: 'black', strokeWidth: 1.5, opacity: 0.8 } }),
	            React.createElement(
	                'text',
	                { x: text_x, y: this.state.y - 4, textAnchor: 'end',
	                    transform: 'translate(-22, 0)' },
	                'Score:'
	            ),
	            React.createElement(
	                'text',
	                { x: text_x, y: this.state.y - 4, textAnchor: 'end', className: 'text-big' },
...
/***/ function(module, exports, __webpack_require__) {
	...
	var BucketCounts = React.createClass({
	    displayName: "BucketCounts",
	    ...
	    render: function render() {
	        ...
	        return React.createElement(
	            "g",
	            { className: "bucket-sizes" },
	            React.createElement(
	                "g",
	                { transform: "rotate(90) translate(" + lineY / 2 + ", " + (-this.props.width + this.props.margin.right - 30) + ")" },
	                React.createElement(
	                    "text",
	                    { textAnchor: "center",
	                        className: "pass" },
	            ...
	            React.createElement(
	                "g",
	                { transform: "rotate(90) translate(" + (lineY + (this.props.height - lineY) / 2) + ", " + (-this.props.width + this.props.margin.right - 30) + ")" },
	                React.createElement(
	                    "text",
	                    { textAnchor: "center",
	                        className: "no-pass" },
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Axis = React.createClass({
	    ...
	    componentWillMount: function componentWillMount() {
	        this.axis = d3.svg.axis().scale(this.props.yScale).orient('left');
	    ...
	    render: function render() {
	        ...
	        return React.createElement('g', { className: 'axis', transform: translate });
	    }
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Error = __webpack_require__(17),
	    Loading = __webpack_require__(16),
	    Dropdown = __webpack_require__(18),
	    SubFilters = __webpack_require__(19);
	...
	var Filters = React.createClass({
	    ...
	    getInitialState: function getInitialState() {
	        return { loading: true,
	            types: [{ value: 'null',
	                label: 'Pick type' }, { value: 'client',
	                label: 'Client' }, { value: 'job',
	                label: 'Job' }] };
	    },
	    ...
	    __fetch: function __fetch(url, callback) {
	    ...
	    fetchBusinessAccounts: function fetchBusinessAccounts() {
	        this.__fetch('reports', (function (data) {
	            this.setState({
	                selectedBA: null,
	                business_accounts: [{ value: 'null',
	                    label: 'Pick account' }].concat(data.map(function (d) {
	                    return { value: d.nid,
	                        label: d.title };
	                }))
	            });
	    ...
	    changeBusinessAccount: function changeBusinessAccount(event) {
	        var account_id = event.currentTarget.value;
	    ...
	    fetchList: function fetchList(type) {
	        var account_id = this.state.selectedBA,
	            label = type == 'job' ? 'Pick job' : 'Pick client';

	        this.__fetch('reports/' + account_id + '/' + type, (function (data) {
	            this.setState({ selectedJob: null,
	                jobs: [{ value: 'null',
	                    label: label }].concat(data.map(function (d) {
	                    return { value: d.nid,
	                        label: d.title };
	                }))
	            });
	    ...
	    changeJob: function changeJob(event) {
	        var job_id = event.currentTarget.value;
	    ...
	    fetchData: function fetchData(job_id) {
	        var account_id = this.state.selectedBA,
	    ...
	    updateFilter: function updateFilter(func) {
	    ...
	    componentDidUpdate: function componentDidUpdate() {
	        if (!this.state.selectedBA || !this.state.selectedJob) {
	            ...
	            if (this.state.data) {
	                var N_all = 0,
	                    data = _.cloneDeep(this.state.data).map(function (data) {
	                    N_all += data.Responses.length;
	                    data.Responses = data.Responses.filter(this.state.filter || function () {
	                        return true;
	                    });

	                    return data;
	                }, this),
	                    caption = _.find(this.state.jobs, function (d) {
	                    return d.value == this.state.selectedJob;
	                }, this).label;
	    ...
	    render: function render() {
	        ...
	        if (this.state.loading) {
	            status = React.createElement(Loading, null);
	        } else if (this.state.error) {
	            status = React.createElement(Error, { error: this.state.error });
	        }

	        if (this.state.business_accounts) {
	            BA_dropdown = React.createElement(Dropdown, { options: this.state.business_accounts,
	        ...
	        if (this.state.selectedBA) {
	            types_dropdown = React.createElement(Dropdown, { options: this.state.types,
	        ...
	        if (this.state.jobs) {
	            jobs_dropdown = React.createElement(Dropdown, { options: this.state.jobs,
	        ...
	        if (this.state.data) {
	            subfilters = React.createElement(SubFilters, { updateFilter: this.updateFilter,
	        ...
	        if (!this.state.selectedBA || !this.state.selectedJob) {
	            if (!this.state.selectedType) {
	                help = React.createElement(
	                    'h2',
	                    null,
	                    'Pick a business account and a chart type to see candidates'
	                );
	            } else {
	                help = React.createElement(
	                    'h2',
	                    null,
	                    'Pick a business account and a ',
	...
	var Dropdown = React.createClass({
	    ...
	    render: function render() {
	        return React.createElement(
	            ...
	            React.createElement(
	                "label",
	                { htmlFor: "dropdown-" + this.props.name },
	                this.props.label,
	                ": "
	            ),
	            React.createElement(
	                "select",
	                { name: this.props.name, id: "dropdown-" + this.props.name,
	...
	var SubFilters = React.createClass({
	    ...
	    getInitialState: function getInitialState() {
	        return { education: '__reset_filter__',
	            ...
	            filters: { education: function education(d) {
	                    return true;
	                },
	                ...
	                reviewer: function reviewer(d) {
	                    return true;
	                } } };
	    },

	    get_values: function get_values(field) {
	        var data = this.props.data;

	        return [{ value: '__reset_filter__',
	            label: 'All' }].concat(_.uniq(data, function (d) {
	            return d.Candidate[field];
	        }).map(function (d) {
	    ...
	    picked_value: function picked_value(data_key, local_key, value) {
	        var filter;

	        if (!value || value == 'null') {
	            filter = function (d) {
	                return !d.Candidate[data_key];
	            };
	        } else if (value != '__reset_filter__') {
	            filter = function (d) {
	                return d.Candidate[data_key] == value;
	            };
	        } else {
	            filter = function () {
	                return true;
	    ...
	    picked_source: function picked_source() {
	        this.picked_value('Source', 'source', event.target.value);
	    },

	    picked_reviewer: function picked_reviewer() {
	    ...
	    componentWillUpdate: function componentWillUpdate(nextProps, nextState) {
	        ...
	        this.props.updateFilter((function (d) {
	            return _.all([education(d), gender(d), source(d), reviewer(d)]);
	        }).bind(this));
	    },
	    ...
	    render: function render() {
	        return React.createElement(
	            'div',
	            { className: 'form-group' },
	            React.createElement(Dropdown, { options: this.get_values('EducationLevel'),
	                onChange: this.picked_education,
	                label: 'Education level',
	                name: 'education',
	                selected: this.state.education }),
	            React.createElement(Dropdown, { options: this.get_values('Gender'),
	                onChange: this.picked_gender,
	                label: 'Gender',
	                name: 'gender',
	                selected: this.state.gender }),
	            React.createElement(Dropdown, { options: this.get_values('Source'),
	                onChange: this.picked_source,
	                label: 'Candidate Source',
	                name: 'source',
	                selected: this.state.source }),
	            React.createElement(Dropdown, { options: this.get_values('Reviewer'),
