...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = __webpack_require__(/*! ./src/main.jsx */1);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(/*! react */ 2),
	    ApplicantsChart = __webpack_require__(/*! ./ApplicantsChart */ 3);
	
	React.render(React.createElement(ApplicantsChart, { url: 'bigscreen.json' }), document.querySelectorAll('.container')[0]);
	
	/* REACT HOT LOADER */ }).call(this); if (false) { (function () { module.hot.dispose(function (data) { data.makeHot = module.makeHot; }); if (module.exports && module.makeHot) { var makeExportsHot = require("/Users/Swizec/Documents/freelancing/bigscreen-applicants-chart/node_modules/react-hot-loader/makeExportsHot.js"), foundReactClasses = false; if (makeExportsHot(module, require("react"))) { foundReactClasses = true; } var shouldAcceptModule = true && foundReactClasses; if (shouldAcceptModule) { module.hot.accept(function (err) { if (err) { console.error("Cannot not apply hot update to " + "main.jsx" + ": " + err.message); } }); } } })(); }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(/*! react */ 2),
	    PureRenderMixin = __webpack_require__(/*! react/addons */ 2).addons.PureRenderMixin,
	    d3 = __webpack_require__(/*! d3 */ 4);
	
	var BubbleChart = __webpack_require__(/*! ./BubbleChart */ 5),
	    Filters = __webpack_require__(/*! ./Filters */ 15);
	        ...
	        if (this.state.error) {
	            ...
	            return React.createElement(
	                ...
	                React.createElement(
	                    'h2',
	                    null,
	                    filtered_data.JobTitle,
	                    ' ',
	                    React.createElement(
	                        'small',
	                        null,
	                        filtered_data.Responses.length,
	                        ' candidates'
	                    )
	                ),
	                React.createElement(BubbleChart, _extends({ data: filtered_data }, this.props)),
	                React.createElement(Filters, { updateFilter: this.updateFilter, data: this.state.data })
	            );
	        } else {
	...
	/* REACT HOT LOADER */ }).call(this); if (false) { (function () { module.hot.dispose(function (data) { data.makeHot = module.makeHot; }); if (module.exports && module.makeHot) { var makeExportsHot = require("/Users/Swizec/Documents/freelancing/bigscreen-applicants-chart/node_modules/react-hot-loader/makeExportsHot.js"), foundReactClasses = false; if (makeExportsHot(module, require("react"))) { foundReactClasses = true; } var shouldAcceptModule = true && foundReactClasses; if (shouldAcceptModule) { module.hot.accept(function (err) { if (err) { console.error("Cannot not apply hot update to " + "ApplicantsChart.jsx" + ": " + err.message); } }); } } })(); }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(/*! react */ 2),
	    _ = __webpack_require__(/*! lodash */ 6),
	    d3 = __webpack_require__(/*! d3 */ 4);
	
	var Candidate = __webpack_require__(/*! ./Candidate */ 8),
	    PassLine = __webpack_require__(/*! ./PassLine */ 12),
	    BucketCounts = __webpack_require__(/*! ./BucketCounts */ 13),
	    Axis = __webpack_require__(/*! ./Axis */ 14);
	...
	var BubbleChart = React.createClass({
	    ...
	    hide_tooltips: function hide_tooltips(event) {
	        _.keys(this.refs).forEach((function (key) {
	            ...
	            if (!event.dispatchMarker.match(key) && component.hide_tooltip) {
	...
	/* REACT HOT LOADER */ }).call(this); if (false) { (function () { module.hot.dispose(function (data) { data.makeHot = module.makeHot; }); if (module.exports && module.makeHot) { var makeExportsHot = require("/Users/Swizec/Documents/freelancing/bigscreen-applicants-chart/node_modules/react-hot-loader/makeExportsHot.js"), foundReactClasses = false; if (makeExportsHot(module, require("react"))) { foundReactClasses = true; } var shouldAcceptModule = true && foundReactClasses; if (shouldAcceptModule) { module.hot.accept(function (err) { if (err) { console.error("Cannot not apply hot update to " + "BubbleChart.jsx" + ": " + err.message); } }); } } })(); }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var CandidateTooltip = __webpack_require__(/*! ./CandidateTooltip */ 9),
	    Icon = __webpack_require__(/*! ./Icon */ 11);
	...
	var Candidate = React.createClass({
	    ...
	    show_tooltip: function show_tooltip() {
	    ...
	    fixSize: function fixSize(info) {
	        this.setState(info);
	    },
	
	    componentDidMount: function componentDidMount() {
	        d3.select(this.getDOMNode()).datum({ id: 'candidate-' + this.props.data.Candidate.Nid });
	    },
	
	    render: function render() {
	        var className = ['candidate', this.props.data.Candidate.Gender.toLowerCase(), this.props.passed ? 'passed' : 'no-passed'].join(' ');
	        ...
	        return React.createElement(
	            ...
	            React.createElement(CandidateTooltip, _extends({
	...
	/* REACT HOT LOADER */ }).call(this); if (false) { (function () { module.hot.dispose(function (data) { data.makeHot = module.makeHot; }); if (module.exports && module.makeHot) { var makeExportsHot = require("/Users/Swizec/Documents/freelancing/bigscreen-applicants-chart/node_modules/react-hot-loader/makeExportsHot.js"), foundReactClasses = false; if (makeExportsHot(module, require("react"))) { foundReactClasses = true; } var shouldAcceptModule = true && foundReactClasses; if (shouldAcceptModule) { module.hot.accept(function (err) { if (err) { console.error("Cannot not apply hot update to " + "Candidate.jsx" + ": " + err.message); } }); } } })(); }

/***/ },
/* 9 */
/*!**********************************!*\
  !*** ./src/CandidateTooltip.jsx ***!
  \**********************************/
/***/ function(module, exports, __webpack_require__) {
	...
	var Stars = __webpack_require__(/*! ./Stars */ 10);
	...
	var CandidateTooltip = React.createClass({
	    ...
	    componentWillUpdate: function componentWillUpdate(props) {
	        if (props.shown) {
	            ...
	            d3.select(svg).selectAll('g.candidate').sort(function (a, b) {
	                if (a.id === top_id) {
	                    return +1;
	                } else if (b.id === top_id) {
	                    return -1;
	            ...
	            d3.select(svg).selectAll('g.pass-line, g#' + top_id).sort(function (a, b) {
	                if (!a) return -1;
	                if (!b) return 1;
	                return 0;
	            });
	    ...
	    render: function render() {
	        ...
	        return React.createElement(
	            ...
	            React.createElement(
	                'div',
	                null,
	                React.createElement('img', { src: candidate.Avatar }),
	                React.createElement(
	                    'div',
	                    { className: 'info' },
	                    React.createElement(
	...
	/* REACT HOT LOADER */ }).call(this); if (false) { (function () { module.hot.dispose(function (data) { data.makeHot = module.makeHot; }); if (module.exports && module.makeHot) { var makeExportsHot = require("/Users/Swizec/Documents/freelancing/bigscreen-applicants-chart/node_modules/react-hot-loader/makeExportsHot.js"), foundReactClasses = false; if (makeExportsHot(module, require("react"))) { foundReactClasses = true; } var shouldAcceptModule = true && foundReactClasses; if (shouldAcceptModule) { module.hot.accept(function (err) { if (err) { console.error("Cannot not apply hot update to " + "CandidateTooltip.jsx" + ": " + err.message); } }); } } })(); }
...
/***/ function(module, exports, __webpack_require__) {
	...
	/* REACT HOT LOADER */ }).call(this); if (false) { (function () { module.hot.dispose(function (data) { data.makeHot = module.makeHot; }); if (module.exports && module.makeHot) { var makeExportsHot = require("/Users/Swizec/Documents/freelancing/bigscreen-applicants-chart/node_modules/react-hot-loader/makeExportsHot.js"), foundReactClasses = false; if (makeExportsHot(module, require("react"))) { foundReactClasses = true; } var shouldAcceptModule = true && foundReactClasses; if (shouldAcceptModule) { module.hot.accept(function (err) { if (err) { console.error("Cannot not apply hot update to " + "Stars.jsx" + ": " + err.message); } }); } } })(); }
...
/***/ function(module, exports, __webpack_require__) {
	...
	/* REACT HOT LOADER */ }).call(this); if (false) { (function () { module.hot.dispose(function (data) { data.makeHot = module.makeHot; }); if (module.exports && module.makeHot) { var makeExportsHot = require("/Users/Swizec/Documents/freelancing/bigscreen-applicants-chart/node_modules/react-hot-loader/makeExportsHot.js"), foundReactClasses = false; if (makeExportsHot(module, require("react"))) { foundReactClasses = true; } var shouldAcceptModule = true && foundReactClasses; if (shouldAcceptModule) { module.hot.accept(function (err) { if (err) { console.error("Cannot not apply hot update to " + "Icon.jsx" + ": " + err.message); } }); } } })(); }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var PassLine = React.createClass({
	    ...
	    render: function render() {
	        return React.createElement(
	            ...
	            React.createElement(
	                'text',
	                { x: '100%', y: this.state.y - 4, textAnchor: 'end',
	...
	/* REACT HOT LOADER */ }).call(this); if (false) { (function () { module.hot.dispose(function (data) { data.makeHot = module.makeHot; }); if (module.exports && module.makeHot) { var makeExportsHot = require("/Users/Swizec/Documents/freelancing/bigscreen-applicants-chart/node_modules/react-hot-loader/makeExportsHot.js"), foundReactClasses = false; if (makeExportsHot(module, require("react"))) { foundReactClasses = true; } var shouldAcceptModule = true && foundReactClasses; if (shouldAcceptModule) { module.hot.accept(function (err) { if (err) { console.error("Cannot not apply hot update to " + "PassLine.jsx" + ": " + err.message); } }); } } })(); }

/***/ },
/* 13 */
/*!******************************!*\
  !*** ./src/BucketCounts.jsx ***!
  \******************************/
/***/ function(module, exports, __webpack_require__) {
	...
	/* REACT HOT LOADER */ }).call(this); if (false) { (function () { module.hot.dispose(function (data) { data.makeHot = module.makeHot; }); if (module.exports && module.makeHot) { var makeExportsHot = require("/Users/Swizec/Documents/freelancing/bigscreen-applicants-chart/node_modules/react-hot-loader/makeExportsHot.js"), foundReactClasses = false; if (makeExportsHot(module, require("react"))) { foundReactClasses = true; } var shouldAcceptModule = true && foundReactClasses; if (shouldAcceptModule) { module.hot.accept(function (err) { if (err) { console.error("Cannot not apply hot update to " + "BucketCounts.jsx" + ": " + err.message); } }); } } })(); }
...
/***/ function(module, exports, __webpack_require__) {
	...
	/* REACT HOT LOADER */ }).call(this); if (false) { (function () { module.hot.dispose(function (data) { data.makeHot = module.makeHot; }); if (module.exports && module.makeHot) { var makeExportsHot = require("/Users/Swizec/Documents/freelancing/bigscreen-applicants-chart/node_modules/react-hot-loader/makeExportsHot.js"), foundReactClasses = false; if (makeExportsHot(module, require("react"))) { foundReactClasses = true; } var shouldAcceptModule = true && foundReactClasses; if (shouldAcceptModule) { module.hot.accept(function (err) { if (err) { console.error("Cannot not apply hot update to " + "Axis.jsx" + ": " + err.message); } }); } } })(); }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Filters = React.createClass({
	    ...
	    get_jobs: function get_jobs() {
	        return _.uniq(this.props.data, function (d) {
	            return d.JobId;
	        }).map(function (d) {
	    ...
	    get_educations: function get_educations() {
	        ...
	        return [{ value: '__reset_filter__',
	            ...
	            return d.Candidate.EducationLevel;
	        }).map(function (d) {
	    ...
	    render: function render() {
	        return React.createElement(
	            ...
	            React.createElement(
	                ...
	                React.createElement(Dropdown, { options: this.get_jobs(),
